...
public class SpatialUnderstandingState : Singleton<SpatialUnderstandingState>, IInputClickHandler, ISourceStateHandler
{
    ...
    public float MinAreaForComplete = 25.0f;
    ...
    private void Update()
    {
        ...
        DebugDisplay.transform.position = headPos + gazeDir * 3;
        DebugDisplay.transform.rotation = new Quaternion(0.0f, Camera.main.transform.rotation.y, 0.0f, Camera.main.transform.rotation.w);

        DebugSubDisplay.transform.position = headPos + gazeDir * 3;
        DebugSubDisplay.transform.rotation = new Quaternion(0.0f, Camera.main.transform.rotation.y, 0.0f, Camera.main.transform.rotation.w);
